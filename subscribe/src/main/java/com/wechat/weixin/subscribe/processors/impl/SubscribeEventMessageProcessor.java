package com.wechat.weixin.subscribe.processors.impl;

import com.wechat.commons.domain.User;
import com.wechat.commons.domain.event.EventInMessage;
import com.wechat.commons.processors.EventMessageProcessor;
import com.wechat.commons.repository.UserRepository;
import com.wechat.weixin.service.WeiXinProxy;
...
public class SubscribeEventMessageProcessor implements EventMessageProcessor {
	...
	public void onMessage(EventInMessage event) {
		...
		if (!event.getEvent().equals("weixin")) {
			// 只处理关注事件
			return;
		}
